...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775290134999-cwdb4a | 2026-04-04T08:08:56.139Z

**Codebase Map:**
  src/: QueryEngine, Task, Tool, commands, context, cost-tracker, costHook, dialogLaunchers, history, ink
  src/assistant/: sessionHistory
  src/bootstrap/: state
  src/bridge/: bridgeApi, bridgeConfig, bridgeDebug, bridgeEnabled, bridgeMain, bridgeMessaging, bridgePermissionCallbacks, bridgePointer, bridgeStatusUtil, bridgeUI
  src/buddy/: CompanionSprite, companion, observer, prompt, sprites, types, useBuddyNotification
  src/cli/: exit, agents, auth, autoMode, mcp, plugins, util, ndjsonSafeStringify, print, remoteIO
  src/commands/: add-dir, validation, advisor, agents, branch
  src/components/: AgentProgressLine, App, ApproveApiKey, AutoModeOptInDialog, AutoUpdater, AutoUpdaterWrapper, AwsAuthStatusBox, BaseTextInput, BashModeProgress, BridgeDialog
  src/constants/: apiLimits, betas, common, cyberRiskInstruction, errorIds, figures, files, github-app, keys, messages
  src/context/: QueuedMessageContext, fpsMetrics, mailbox, modalContext, notifications, overlayContext, promptOverl...
